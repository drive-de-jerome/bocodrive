  ...
  <div class="blockcart cart-preview {if $cart.products_count > 0}active{else}inactive{/if}" data-refresh-url="{$refresh_url}">
    <div class="header blockcart-header dropdown js-dropdown">
		...
		<a class="shopping-cart" rel="nofollow" href="{$cart_url}" {if $cart.products_count > 0} data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"{/if}>
			...
			<span class="hidden-sm-down cart-headding">{l s='Your Bag' d='Shop.Theme.Global'}</span>
			<span class="mobile_count">{$cart.products_count}</span>
			{*<span class="cart-products-count hidden-sm-down">{if $cart.products_count > 0}{l s='Items' d='Shop.Theme.Global'}{else}{l s='Item' d='Shop.Theme.Global'}{/if} ({$cart.products_count})</span>*}
		</a>
