	...
	<div class="col-xs-12 col-sm-7 blog-content-wrap">
		...
		<div class="blog-meta">
			...
			<span class="blog-author">
				<i class="fa fa-user"></i> {* <span> {l s='Posted By' mod='psblog'}:</span>  *}
			...
			<span class="blog-cat"> 
				<i class="fa fa-list"></i> {* <span> {l s='In' mod='psblog'}:</span> *}
			...
			<span class="blog-created">
				<i class="fa fa-calendar"></i> {* <span> {l s='On' mod='psblog'}: </span> *} 
			...
			<span class="blog-ctncomment">
				<i class="fa fa-comments-o"></i> {* <span> {l s='Comment' mod='psblog'}:</span> *}
			...
			<span class="blog-hit">
				<i class="fa fa-heart"></i> {* <span> {l s='Hit' mod='psblog'}:</span> *} 
				{$blog.hits|intval}
			</span>
			{/if}
		</div>
