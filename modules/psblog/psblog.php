...
class Psblog extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('Ps Blog Management');
        $this->description = $this->trans('Manage Blog Content');
...
//        $id_tab1 = $tab1->add(true, false);
    ...
    public function install()
    {
        ...
        if (parent::install()
            ...
            Configuration::updateValue('PsBLOG_LASTEST_HEIGHT', 643);
            Configuration::updateValue('PsBLOG_LASTEST_WIDTH', 905);
...
//            $id_tab1 = $tab1->add(true, false);
        ...
        $fields_form = array(
            'form' => array(
                ...
                'input' => array(
                    array(
                        'type' => 'switch',
                        'label' => $this->trans('Enable Categories Tree Block'),
                        'name' => 'PsBLOG_CATEORY_MENU',
                        'desc' => $this->trans('Activate  The Module.'),
                        'values' => array(
                            array(
                                'id' => 'active_on',
                                'value' => 1,
                    ...
                    array(
                        'type' => 'switch',
                        'label' => $this->trans('Enable Lastest Post'),
   ...
   public function hookLeftColumn()
    ...
    /*
      ...
      {
      Tools::dieOrLog(sprintf($this->trans('Error: invalid RSS feed in "psblogrss" module: %s'), $e->getMessage()), false);
      }

      // Display smarty
      $this->smarty->assign(array('title' => ($title ? $title : $this->trans('RSS feed')), 'rss_links' => $rss_links));
      }
