		...
		<div id="mywishlist">
			...
			<div class="new-wishlist">
				...
				{if $wishlists}
					<table class="table table-striped hidden-sm-down">
					  ...
					  <tbody>
							{foreach from=$wishlists item=wishlists_item name=for_wishlists}
								<tr>					 
									<td><a href="#" class="view-wishlist-product" data-name-wishlist="{$wishlists_item.name}" data-id-wishlist="{$wishlists_item.id_wishlist}"><i class="fa fa-list" aria-hidden="true"></i>&nbsp; {$wishlists_item.name}</a><div class="st-view-wishlist-product-loading st-view-wishlist-product-loading-{$wishlists_item.id_wishlist} cssload-speeding-wheel"></div></td>
					...
					<div class="mywishlist-res hidden-md-up">
						{foreach from=$wishlists item=wishlists_item}
						<div class="wish-list">
							<div class="row">
								<div class="col-xs-10">
									<a href="#" class="view-wishlist-product" data-name-wishlist="{$wishlists_item.name}" data-id-wishlist="{$wishlists_item.id_wishlist}"><i class="material-icons">&#xE8EF;</i>{$wishlists_item.name}</a><div class="st-view-wishlist-product-loading st-view-wishlist-product-loading-{$wishlists_item.id_wishlist} cssload-speeding-wheel"></div>
									<div class="wishlist-numberproduct wishlist-numberproduct-{$wishlists_item.id_wishlist}">
										{$wishlists_item.number_product|intval}
									</div>
									<div class="wishlist-datecreate">
										{$wishlists_item.date_add}
									</div>
									<a class="view-wishlist" data-token="{$wishlists_item.token}" target="_blank" href="{$view_wishlist_url}{if $leo_is_rewrite_active}?{else}&{/if}token={$wishlists_item.token}" title="{l s='View' mod='stfeature'}">{l s='View' mod='stfeature'}</a>
									<a class="delete-wishlist" data-id-wishlist="{$wishlists_item.id_wishlist}" href="#" title="{l s='Delete' mod='stfeature'}"><i class="material-icons">&#xE872;</i></a>
								</div>
							</div>
						</div>
						{/foreach}
			...
			<div class="send-wishlist">
				<a class="st-send-wishlist-button btn btn-primary" href="#" title="{l s='Send this wishlist' mod='stfeature'}">
